...
logo = PhotoImage(file="Immagini/whitebox.gif")      # Loading all the image files that are required in the game.
logo2 = PhotoImage(file="Immagini/red side.gif")     # Loading all the image files that are required in the game.
logo3 = PhotoImage(file="Immagini/red.gif")          # Loading all the image files that are required in the game.
logo4 = PhotoImage(file="Immagini/blue side.gif")
logo5 = PhotoImage(file="Immagini/green side.gif")
logo6 = PhotoImage(file="Immagini/yellow side.gif")
logo7 = PhotoImage(file="Immagini/center.gif")
logoxx = PhotoImage(file="Immagini/test.gif")
logog = PhotoImage(file="Immagini/greenbox.gif")
logogs = PhotoImage(file="Immagini/greenstop.gif")
logoy = PhotoImage(file="Immagini/yellowbox.gif")
logoys = PhotoImage(file="Immagini/yellowstop.gif")
logob = PhotoImage(file="Immagini/bluebox.gif")
logobs = PhotoImage(file="Immagini/bluestop.gif")
logor = PhotoImage(file="Immagini/redbox.gif")
logors = PhotoImage(file="Immagini/redstop.gif")
logoh = PhotoImage(file="Immagini/head.gif")
logot = PhotoImage(file="Immagini/tail.gif")
logoh1 = PhotoImage(file="Immagini/head1.gif")
logot1 = PhotoImage(file="Immagini/tail1.gif")
logoh2 = PhotoImage(file="Immagini/head2.gif")
logot2 = PhotoImage(file="Immagini/tail2.gif")
logoh3 = PhotoImage(file="Immagini/head3.gif")
logot3 = PhotoImage(file="Immagini/tail3.gif")
logoab= PhotoImage(file="Immagini/blue.gif")
logoay= PhotoImage(file="Immagini/yellow.gif")
logoag= PhotoImage(file="Immagini/green.gif")
